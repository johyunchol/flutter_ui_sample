        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text("'더 나은 리더'가 되는 법", style: TextStyle(fontWeight: FontWeight.w700, fontSize: 24)),
              SizedBox(height: 8),
              Text("[무료] 리더십 아티클, 영상 공개", style: TextStyle(fontSize: 16))
            ],
          ),
        ),
        Stack(
          children: [
            ...
            Container(
              ...
              child: PageView.builder(
                ...
                onPageChanged: (index) {
                  setState(() {
                    currentIndex = index % pageColors.length;
                  });
                },
                itemBuilder: (BuildContext context, int index) {
                  return _item(color: pageColors[index % pageColors.length]);
                },
              ),
            ),
          ],
